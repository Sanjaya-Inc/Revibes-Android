...
fun EditVoucherScreen(
    ...
    LaunchedEffect(voucherId) {
        viewModel.onEvent(EditVoucherScreenUiEvent.Initialize(voucherId))
    }
        ...
        Box(
            ...
            if (state.isLoadingVoucher) {
                            ...
                            Row(
                                ...
                                Row(
                                    ...
                                    Switch(
                                        ...
                                        onCheckedChange = {
                                            viewModel.onEvent(EditVoucherScreenUiEvent.IsActiveChanged(it))
                                        }
                                    )
                                }
                            }
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            OutlinedTextField(
                                value = state.code,
                                onValueChange = {
                                    viewModel.onEvent(EditVoucherScreenUiEvent.CodeChanged(it))
                                },
                            ...
                            OutlinedTextField(
                                value = state.name,
                                onValueChange = {
                                    viewModel.onEvent(EditVoucherScreenUiEvent.NameChanged(it))
                                },
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = {
                                    viewModel.onEvent(EditVoucherScreenUiEvent.DescriptionChanged(it))
                                },
                        ...
                        Column(
                            ...
                            ExposedDropdownMenuBox(
                                ...
                                ExposedDropdownMenu(
                                    ...
                                    DropdownMenuItem(
                                        ...
                                        onClick = {
                                            viewModel.onEvent(
                                                EditVoucherScreenUiEvent.TypeChanged(
                                                    VoucherDomain.VoucherType.PERCENT_OFF
                                                )
                                            )
                                            typeExpanded = false
                                        }
                            ...
                            Row(
                                ...
                                OutlinedTextField(
                                    value = state.amount,
                                    onValueChange = {
                                        viewModel.onEvent(EditVoucherScreenUiEvent.AmountChanged(it))
                                    },
                                    label = {
                                        Text(
                                            when (state.type) {
                                        ...
                                        ExposedDropdownMenu(
                                            ...
                                            VoucherDomain.Currency.values().forEach { currency ->
                                                DropdownMenuItem(
                                                    ...
                                                    onClick = {
                                                        viewModel.onEvent(
                                                            EditVoucherScreenUiEvent.CurrencyChanged(currency)
                                                        )
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            Row(
                                ...
                                TextButton(
                                    onClick = {
                                        viewModel.onEvent(EditVoucherScreenUiEvent.ToggleConditionsSection)
                                    }
                                ) {
                                ...
                                Column(
                                    ...
                                    Row(
                                        ...
                                        OutlinedTextField(
                                            ...
                                            onValueChange = {
                                                viewModel.onEvent(EditVoucherScreenUiEvent.MaxClaimChanged(it))
                                            },
                                        ...
                                        OutlinedTextField(
                                            ...
                                            onValueChange = {
                                                viewModel.onEvent(EditVoucherScreenUiEvent.MaxUsageChanged(it))
                                            },
                                    ...
                                    OutlinedTextField(
                                        ...
                                        onValueChange = {
                                            viewModel.onEvent(EditVoucherScreenUiEvent.MinOrderItemChanged(it))
                                        },
                                    ...
                                    OutlinedTextField(
                                        ...
                                        onValueChange = {
                                            viewModel.onEvent(EditVoucherScreenUiEvent.MinOrderAmountChanged(it))
                                        },
                                    ...
                                    OutlinedTextField(
                                        ...
                                        onValueChange = {
                                            viewModel.onEvent(EditVoucherScreenUiEvent.MaxDiscountAmountChanged(it))
                                        },
                    ...
                    Card(
                        ...
                        Column(
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = {
                                    viewModel.onEvent(EditVoucherScreenUiEvent.ClaimPeriodStartChanged(it))
                                },
                            ...
                            OutlinedTextField(
                                ...
                                onValueChange = {
                                    viewModel.onEvent(EditVoucherScreenUiEvent.ClaimPeriodEndChanged(it))
                                },
                                label = { Text("End Date") },
                                modifier = Modifier.fillMaxWidth(),
                                trailingIcon = {
                ...
                Button(
                    ...
                    onClick = {
                        viewModel.onEvent(EditVoucherScreenUiEvent.SaveVoucher)
                    },
                    modifier = Modifier
